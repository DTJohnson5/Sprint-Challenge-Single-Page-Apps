...
> Answer: The main benefit of using client-side routing is because it allows for the accessability of URLs and/or other "links" on a page without the need to completely
reload it due to it being saved in your browsers cache.
